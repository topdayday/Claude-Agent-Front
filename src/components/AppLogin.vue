<template>
  <div>
    <div class="content-main" id="login_index">
      <h1 class="index_title" v-bind:class="{index_title:isHidden,index_title_min:isHidden }" >Claude Agent</h1>
      <div  class="card_contains">
        <div  v-bind:class="{card_item:true }">
          <h3 class="gmat-headline-4 gradient gradient-1">Claude【高性能】</h3>
        ...
        <div  v-bind:class="{card_item:true,hidden: isHidden }">
          <h3 class="gmat-headline-4 gradient gradient-1">Claude【高质量】</h3>
